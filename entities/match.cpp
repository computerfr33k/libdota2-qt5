...
int Match::getStartTime()
{
    return this->start_time;
}

qint64 Match::getMatchId()
{
    return this->match_id;
}

qint64 Match::getMatchSequenceNumber()
{
    return this->match_seq_num;
}

int Match::getTowerStatusRadiant()
{
    return this->tower_status_radiant;
}

int Match::getTowerStatusDire()
{
    return this->tower_status_dire;
}

int Match::getBarracksStatusRadiant()
{
    return this->barracks_status_radiant;
}

int Match::getBarracksStatusDire()
{
    return this->barracks_status_dire;
}

int Match::getCluster()
{
    return this->cluster;
}

int Match::getFirstBloodTime()
{
    return this->first_blood_time;
}

int Match::getLobbyType()
{
    return this->lobby_type;
}

int Match::getHumanPlayers()
{
    return this->human_players;
}

int Match::getLeagueId()
{
    return this->leagueid;
}

int Match::getPositiveVotes()
{
    return this->positive_votes;
}

int Match::getNegativeVotes()
{
...
int Match::getRadiantScore()
{
    return this->radiant_score;
}

int Match::getDireScore()
{
